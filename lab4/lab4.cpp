...
int main()
{
	...
	do
	{
		...
		cout << "10.Додати до цього числа данні;" << endl << "11.Помножити це число на число;" << endl << "12.Поділити це число на число;" << endl << "13.Перевірити 2 комплексних числа на рівність;" << endl;
		cout << "14.Додати новий елемент класу;" << endl << "15.Завершити програму" << endl;
		...
		case 10:
		{
			cout << "Введіть дійсну частину яку додамо: ";
			cin >> material;
			cout << "Введіть уявну частину яку додамо: ";
			cin >> imaginary;
			cout << "Введіть назву для комплексного числа яку додамо: ";
			cin >> name;

			ComplexNum for_test(material, imaginary, name);

			complex_nums[i] = complex_nums[i] + for_test;
			complex_nums[i].PrintComplexNum();
		...
		case 11:
		{
			cout << "Введіть дійсну частину яку помножимо: ";
			cin >> material;
			cout << "Введіть уявну частину яку помножимо: ";
			cin >> imaginary;
			cout << "Введіть назву для комплексного числа: ";
			cin >> name;
		...
		case 12:
		{
			cout << "Введіть дійсну частину яку поділимо: ";
			cin >> material;
			cout << "Введіть уявну частину яку поділимо: ";
			cin >> imaginary;
			cout << "Введіть назву для комплексного числа: ";
			cin >> name;
		...
		case 13:
		{
			cout << "Введіть дійсну частину з якою порівняємо: ";
			cin >> material;
			cout << "Введіть уявну частину з якою порівняємо: ";
			cin >> imaginary;
			cout << "Введіть назву для комплексного числа з якою порівняємо: ";
			cin >> name;

			ComplexNum for_test(material, imaginary, name);

			cout << (complex_nums[i] == for_test) << endl;
			break;
		}
		case 14:
			if (i < size)
